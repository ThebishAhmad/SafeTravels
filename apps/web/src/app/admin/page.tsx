...
const stats = [
    { label: "Active Buses", value: "3", icon: "M8 7h8m-8 4h4m-6 4h10M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z", color: "text-primary" },
    { label: "Open Rides", value: "7", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z", color: "text-cta" },
    { label: "Pending Complaints", value: "2", icon: "M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z", color: "text-warning" },
    { label: "Registered Students", value: "1,243", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z", color: "text-success" },
];

const recentComplaints = [
    { id: "C-1", type: "DRIVER", target: "Auto #PB-08-1234", status: "IN_PROGRESS", date: "2026-02-14" },
    { id: "C-2", type: "BUS", target: "BUS-03", status: "RESOLVED", date: "2026-02-10" },
    { id: "C-3", type: "RIDE", target: "RIDE-38", status: "OPEN", date: "2026-02-14" },
];
...
const routeManagement = [
    { id: "route-1", name: "Campus → City Stand", buses: 2, status: "Active" },
    { id: "route-2", name: "Campus → Railway Station", buses: 1, status: "Active" },
    { id: "route-3", name: "Campus → Bus Stand", buses: 1, status: "Active" },
];
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    {stats.map((s) => (
                        <div key={s.label} className="bg-surface border border-border rounded-2xl p-5">
                            ...
                            <p className="text-2xl font-bold text-text" style={{ fontFamily: "'Cinzel', serif" }}>{s.value}</p>
                            ...
                            {routeManagement.map((route) => (
                                <div key={route.id} className="p-4 flex items-center justify-between hover:bg-background-alt transition-colors duration-200 cursor-pointer">
                                    <div>
                                        ...
                                        <p className="text-xs text-text-muted mt-0.5">{route.buses} buses assigned</p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-xs bg-success/10 text-success px-2 py-0.5 rounded-full font-medium">{route.status}</span>
